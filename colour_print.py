...
colorama.init()
colour_print("Hello, Red and Underlined", RED, UNDERLINE)
# test that the colour was reset
print("This should be in the default terminal colour")
colour_print("Hello, Blue and Reversed", BLUE, REVERSE)
colour_print("Hello, Yellow, Bold, and Underlined", YELLOW, BOLD, UNDERLINE)
